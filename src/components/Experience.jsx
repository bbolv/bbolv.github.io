  ...
  const experiences = [
    {
      ...
      tech: ['TypeScript', 'NestJS', 'Flutter', 'MongoDB', 'Redis', 'GraphQL', 'AWS (S3)', 'Github Actions', 'Figma']
    },
    {
      ...
      tech: ['React', 'Node.js', 'Express', 'GraphQL', 'Socket.IO', 'MongoDB', 'AWS (EC2)', 'AWS (EKS/ECS)']
    }
  ];
